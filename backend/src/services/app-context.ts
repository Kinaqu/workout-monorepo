...
export function createAppContext(env: Env) {
  ...
  return {
    programService: new ProgramService(lifecycle, programs, progression),
    programGeneratorService,
    workoutService: new WorkoutService(lifecycle, progression),
    sessionService: new SessionService(lifecycle, sessions),
    progressionService: new ProgressionService(lifecycle, programs, progression, sessions),
