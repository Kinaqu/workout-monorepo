// Feature controller: owns the History tab's imperative surface (driven by the
// shell) and the external view state its component renders. Ported verbatim
// from frontend/features/history/index.ts (only import paths changed).
...
import type { HistoryTabProps, HistoryViewState } from './HistoryTab';
