// Feature controller for the recommendation shell; ported verbatim from
// frontend/features/recommendation/index.ts (only import paths changed).
// enter() keeps the old throwing contract: AuthRedirect and draft-unsupported
// errors propagate so the route can fall back to the plan-recovery flow.
