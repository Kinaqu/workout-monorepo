// Imperative snapshot of the product lifecycle, shared by the navigation gate
// and the feature controllers. A plain module (not React state): consumers only
// need point-in-time reads right after the shell refreshes /me. Lives in lib/
// (not app/) because everything under app/ is an Expo Router route.
import type { MeResponse, OnboardingStateResponse } from '@/lib/api/contracts';
